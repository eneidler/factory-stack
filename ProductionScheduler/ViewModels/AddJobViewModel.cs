...
namespace ProductionScheduler.ViewModels {
    internal class AddJobViewModel : BaseViewModel, IFieldValidation {
        ...
        public ICommand AddJobCommand => _addJobCommand = new RelayCommand<object>(_ => AddNewJobToDatabase());
